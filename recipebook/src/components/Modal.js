            ...
            <div className="modal-dialog modal-fullscreen">
                <div className="modal-content" style={{ background: "#FDF4E3" }}>
                    <div className="modal-header">
                        <h1 className="modal-title" id="recipeModalLabel">Recipe Name</h1>
                        <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div className="modal-body">
                        <img src={"https://www.themealdb.com/images/media/meals/usuqtp1511385394.jpg"} alt="body" style={{width: "50%"}}/>
                        ...
                        <div className="container-fluid">
                            <div className="row justify-content-evenly" style={{ marginTop: 20 }}>
                                ...
                                <div className="col">
                                    ...
                                    Continue to bake for 35-40 mins until the filling has just set. Leave to cool, then remove the pie from the tin. 
